...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            ...
            <li><a href="https://instagram.com/${variables.twitter}"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
...
window.onload = function () {
  window.variables = {
    ...
    background: "https://concepto.de/wp-content/uploads/2018/08/monta%C3%B1as-e1533762816593.jpg",
    // this is the url for the profile avatar
    avatarURL: "https://i.ibb.co/QPn4FRv/aaaa.jpg",
